            ...
            <table class="table table-striped table-hover">
              ...
              <tbody>
                <tr>
                  ...
                  <td><?php echo $data["type_suits"] ; ?></td>
                  <td><img style="width: 46px" src=/assets/uploads/<?=$data["room_img"] ?> /></td>
                  <td>
                    <a href="<?php BURL ?>/rooms/update/<?=$data["id_room"] ?>" class="edit"
                      ><i class="material-icons" title="Edit">&#xE254;</i></a
                    >
                    <a href="<?php BURL ?>/rooms/delete_room/<?=$data["id_room"] ?>"  class="delete"
              ...
              <ul class="pagination">
                ...
                $i =1;
                while ($total_pages >= $i) {?>
                 <li class="page-item <?php if($page_active  == $i )echo 'active'?>"><a class="page-link" href="http://pesta.local//rooms/dashbord/<?php echo $i ?>"> <?php  echo $i ?> </a></li>
